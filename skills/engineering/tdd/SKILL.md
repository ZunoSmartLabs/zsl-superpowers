...
- [ ] Identify opportunities for [deep modules](../codebase-design/SKILL.md) (small interface, deep implementation)
- [ ] Design interfaces for [testability](../codebase-design/SKILL.md)
