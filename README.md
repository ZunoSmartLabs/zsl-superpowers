...
- **[timesheet](./skills/productivity/timesheet/SKILL.md)** — Summarize recent Claude Code sessions, Granola meetings and calendar events into timesheet bullets grouped by customer, then propose and log the matching Harvest entries.
