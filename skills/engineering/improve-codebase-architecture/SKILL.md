...
- **Seam** — where an interface lives; a place behaviour can be altered without editing in place. (Clean Architecture's "boundary" is a particular kind of seam — one that also enforces a dependency direction. See [LANGUAGE.md](LANGUAGE.md).)
