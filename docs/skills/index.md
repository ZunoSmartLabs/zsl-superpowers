...
| [timesheet](timesheet.md) | Claude Code sessions + Granola meetings + calendar events → standup bullets grouped by customer, then proposed Harvest time entries logged on your yes. |
