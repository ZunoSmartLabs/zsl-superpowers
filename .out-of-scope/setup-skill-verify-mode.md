# Verify/Check Mode for `setup-zsl-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-zsl-skills`.
...
- #106 — Feature request: verify/check mode for setup-zsl-skills
